 ...
 *   Username: vishwas
 *   Password: hashed in DB (set via schema.sql seed)
 * 
 * TO ADD A NEW ADMIN: insert a row into the `admins` table with a
 * password_hash generated by PHP's password_hash('your_password', PASSWORD_DEFAULT).
 * 
